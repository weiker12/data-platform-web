!(function(e) {
    ...
    var o = (function() {
      ...
      u = (function() {
        ...
        if (
          ...
          h &&
            !f &&
            ((e.ios = e.iphone = !0), (e.version = h[2].replace(/_/g, '.'))),
  ...
  function(e, t, n) {
    ...
    function i(e) {
      ...
      return (
        2 === i
          ? ((o = (l[e.charCodeAt(t)] << 2) | (l[e.charCodeAt(t + 1)] >> 4)),
            (a[u++] = 255 & o))
          : 1 === i &&
            ((o =
              (l[e.charCodeAt(t)] << 10) |
    ...
    function u(e) {
      for (
        var t, n = e.length, r = n % 3, o = '', i = [], a = 0, u = n - r;
        a < u;
        a += 16383
      )
              ...
              value: function(t, n, r) {
                ...
                var p =
                    ...
                    y.default.aliyunEncodeURI(
                      y.default.makeChangeSiga(h, t.accessKeySecret),
                    ),
